...
export type PaperStyledTabInfo = {
  key: string;
  title: string;
  iconInactive: string;
  iconActive: string;
...
type PaperStyledTabsProps = {
  tabs: PaperStyledTabInfo[];
};

const PaperStyledTabs = ({ tabs }: PaperStyledTabsProps) => {
...
export default PaperStyledTabs;
